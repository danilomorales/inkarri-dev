...
class TestUserService(BaseTestCase):
    ...
    def test_users(self):
        """Asegurando que la ruta """
        """/ping se comporta correctamente."""
    ...
    def test_add_user_invalid_json(self):
        """Asegurando de que se arroje un"""
        """error si el objeto json esta vacio."""
        with self.client:
            response = self.client.post(
                '/users',
                data=json.dumps({}),
    ...
    def test_add_user_invalid_json_keys(self):
        ...
        """si el objeto JSON no tiene un"""
        """key de nombre de usuario"""
        with self.client:
            response = self.client.post(
                '/users',
    ...
    def test_add_user_duplicate_email(self):
        """Asegurando de que se produce un"""
        """error si el correo electronico ya existe."""
        with self.client:
            self.client.post(
                '/users',
                data=json.dumps({
    ...
    def test_single_user_no_id(self):
        """Asegurando de que se lanze un"""
        """error si no se proporciona un id."""
        with self.client:
    ...
    def test_single_user_incorrect_id(self):
        """Asegurando de que se"""
        """lanze un error si el id no existe."""
        with self.client:
    ...
    def test_all_users(self):
        ...
        """usuarios se comporte correctamente."""
    ...
    def test_main_no_users(self):
        ...
        """correctly when no users have been"""
